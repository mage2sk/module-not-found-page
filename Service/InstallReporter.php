<?php
/**
 * Standalone install + heartbeat reporter for Panth_NotFoundPage.
 *
...
namespace Panth\NotFoundPage\Service;
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_NotFoundPage';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-not-found-page';
